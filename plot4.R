...
###############################################
#recreating plot 4, outputting to PNG
...
#topright
plot(y = feb$Voltage, x = feb$datetime,
     xlab = "datetime", ylab = "Voltage", type = "n")
lines(y = feb$Voltage, x = feb$datetime)

#bottomright
plot(y = feb$Global_reactive_power, x = feb$datetime,
     xlab = "datetime", ylab = "Global_reactive_power",
     type = "n")
lines(y = feb$Global_reactive_power, x = feb$datetime)
